...
// todo vive dentro de la instancia devuelta por initAsteroids().
...
export function initAsteroids(canvas: HTMLCanvasElement, cb: AsteroidsCallbacks): AsteroidsEngine {
  ...
  function draw() {
    ...
    ship.draw(ctx);
    // HUD y overlays los dibuja React, no el canvas.
  }

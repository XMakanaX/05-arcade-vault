...
import type { Game, ScoreRow } from "@/app/lib/supabase/queries";

type TickerRow = ScoreRow & { game: string; time: string; color: string };
      ...
      <section className="home-hero">
        ...
        <div className="home-hero-inner">
          ...
          <div className="home-ctas">
            ...
            <Link href="/acceder" className="btn xl magenta">
              ✦ CREAR CUENTA
            </Link>
          </div>
      ...
      <section className="home-section reveal">
        ...
        <div className="pricing-grid">
          <div className="price-card">
            ...
            <Link href="/acceder" className="btn xl pulse" style={{ width: "100%" }}>
              EMPEZAR GRATIS →
            </Link>
